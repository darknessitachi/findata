...
public class TdxMinuteDepthCacheFactory implements DepthCacheFactory<Stock> {

	private final TdxEOMCacheFactory eom;

	public TdxMinuteDepthCacheFactory() {
		this.eom = new TdxEOMCacheFactory();
	}
