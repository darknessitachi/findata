 ...
 */
@javax.persistence.Table(name = "cash_flow_nf", schema = "", catalog = "findata")
@Entity
public class CashFlowNf {
	private int id;
	...
	@javax.persistence.Column(name = "cf48", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf48() {
		return cf48;
	}

	public void setCf48(double cf48) {
		this.cf48 = cf48;
	}

	private double cf49;

	@javax.persistence.Column(name = "cf49", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf49() {
		return cf49;
	}

	public void setCf49(double cf49) {
		this.cf49 = cf49;
	}

	private double cf50;

	@javax.persistence.Column(name = "cf50", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf50() {
		return cf50;
	}

	public void setCf50(double cf50) {
		this.cf50 = cf50;
	}

	private double cf51;

	@javax.persistence.Column(name = "cf51", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf51() {
		return cf51;
	}

	public void setCf51(double cf51) {
		this.cf51 = cf51;
	}

	private double cf52;

	@javax.persistence.Column(name = "cf52", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf52() {
		return cf52;
	}

	public void setCf52(double cf52) {
		this.cf52 = cf52;
	}

	private double cf53;

	@javax.persistence.Column(name = "cf53", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf53() {
		return cf53;
	}

	public void setCf53(double cf53) {
		this.cf53 = cf53;
	}

	private double cf54;

	@javax.persistence.Column(name = "cf54", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf54() {
		return cf54;
	}

	public void setCf54(double cf54) {
		this.cf54 = cf54;
	}

	private double cf55;

	@javax.persistence.Column(name = "cf55", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf55() {
		return cf55;
	}

	public void setCf55(double cf55) {
		this.cf55 = cf55;
	}

	private double cf56;

	@javax.persistence.Column(name = "cf56", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf56() {
		return cf56;
	}

	public void setCf56(double cf56) {
		this.cf56 = cf56;
	}

	private double cf57;

	@javax.persistence.Column(name = "cf57", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf57() {
		return cf57;
	}

	public void setCf57(double cf57) {
		this.cf57 = cf57;
	}

	private double cf58;

	@javax.persistence.Column(name = "cf58", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf58() {
		return cf58;
	}

	public void setCf58(double cf58) {
		this.cf58 = cf58;
	}

	private double cf59;

	@javax.persistence.Column(name = "cf59", nullable = true, insertable = true, updatable = true, length = 22, precision = 0)
	@Basic
	public double getCf59() {
		return cf59;
	}

	public void setCf59(double cf59) {
		this.cf59 = cf59;
	}
